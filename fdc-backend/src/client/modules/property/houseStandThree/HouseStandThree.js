...
import styles from './HouseStandThree.less'

import HouseStandThreeName from './HouseStandThree.name'
import HouseStandThreeFactor from './HouseStandThree.factor'

const confirm = Modal.confirm

/**
 * 住宅 楼盘标准差V3.0 / 城市标准差V3.0
 * author: wy
 */
class HouseStand extends Component {
  ...
  handleStartUpload = taskName => {
    ...
    formData.append('importType', '1212122')
  ...
  renderBreads() {
    ...
    breadList.push({
      key: 5,
      path: '',
      name: projectId ? '楼盘标准差V3.0' : '城市标准差V3.0'
    })
        ...
        {sysStatus === 1 ? (
          <Fragment>
            <Row style={{ marginTop: 8 }}>
              ...
              {pagePermission('fdc:hd:residence:base:ratioThree:export') ? (
                <Button
                  style={{ marginLeft: 8 }}
              ...
              {pagePermission('fdc:hd:residence:base:ratioThree:reset') ? (
                <Button
                  style={{ marginLeft: 8 }}
