...
class CasePriceAdd extends Component {
  static propTypes = {
    ...
    addAvgHistory: PropTypes.func.isRequired,
  ...
  handleUseMonthChange = (date, cityId, flag) => {
    ...
    // }
    // 根据月份获取案例均价详情 WY
    this.props.getMonthToDetail(params, () => {
      this.setState({ detailLoading: false })
    })
  }
  ...
  hanldeProjectAvgPriceBlur = value => {
    // 上个月案例均价
    const { preProjectAvgPrice } = this.props.monthToDetail
    // 当前输入的案例均价
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        this.props.addAvgHistory(values, result => {
  ...
  renderForm() {
    ...
    const { monthToDetail } = this.props
    // // 案例均价参考值显示
    // let content = ''
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="挂牌案例均价(元/㎡)">
              {getFieldDecorator('projectAvgPrice', {
                initialValue: monthToDetail.projectAvgPrice
              })(
                <InputNumber
                  max={1000000000}
                  min={0}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="涨跌幅(%)">
              {getFieldDecorator('projectGained', {
                initialValue: monthToDetail.projectGained
              })(
                <InputNumber
                  precision={2}
                  min={-99}
          ...
          <Col span={10}>
            <FormItem label="只反调差的案例均价" {...formItemLayout}>
              {getFieldDecorator('inverseDiffAvgPrice', {
                initialValue: monthToDetail.inverseDiffAvgPrice
          ...
          <Col span={10}>
            <FormItem label="挂牌案例均价值参考" {...formItemLayout}>
              {getFieldDecorator('projectReferencePrice', {
                initialValue: monthToDetail.projectReferencePrice
              })(<Input disabled style={{ width: '100%' }} />)}
            </FormItem>
          </Col>
        </Row>
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="低层挂牌案例均价(元/㎡)">
              {getFieldDecorator('lowLayerPrice', {
                initialValue: monthToDetail.lowLayerPrice
              })(
                <InputNumber
                  max={1000000000}
                  min={0}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="多层挂牌案例均价(元/㎡)">
              {getFieldDecorator('multiLayerPrice', {
                initialValue: monthToDetail.multiLayerPrice
              })(
                <InputNumber
                  max={1000000000}
                  min={0}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="小高层挂牌案例均价(元/㎡)">
              {getFieldDecorator('smallHighLayerPrice', {
                initialValue: monthToDetail.smallHighLayerPrice
              })(
                <InputNumber
                  max={1000000000}
                  min={0}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="高层挂牌案例均价(元/㎡)">
              {getFieldDecorator('highLayerPrice', {
                initialValue: monthToDetail.highLayerPrice
              })(
                <InputNumber
                  max={1000000000}
                  min={0}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="超高层挂牌案例均价(元/㎡)">
              {getFieldDecorator('superHighLayerPrice', {
                initialValue: monthToDetail.superHighLayerPrice
              })(
                <InputNumber
                  max={1000000000}
                  min={0}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="别墅(元/㎡)">
              {getFieldDecorator('villaPrice', {
                initialValue: monthToDetail.villaPrice
              })(
                <InputNumber
                  max={1000000000}
                  min={0}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="联排别墅(元/㎡)">
              {getFieldDecorator('platoonVillaPrice', {
                initialValue: monthToDetail.platoonVillaPrice
              })(
                <InputNumber
                  max={1000000000}
                  min={0}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="独幢别墅(元/㎡)">
              {getFieldDecorator('singleVillaPrice', {
                initialValue: monthToDetail.singleVillaPrice
              })(
                <InputNumber
                  max={1000000000}
                  min={0}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="叠加别墅(元/㎡)">
              {getFieldDecorator('superpositionVillaPrice', {
                initialValue: monthToDetail.superpositionVillaPrice
              })(
                <InputNumber
                  max={1000000000}
                  min={0}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="双拼别墅(元/㎡)">
              {getFieldDecorator('duplexesVillaPrice', {
                initialValue: monthToDetail.duplexesVillaPrice
              })(
                <InputNumber
                  max={1000000000}
                  min={0}
