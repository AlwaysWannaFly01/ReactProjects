...
class BasePriceDetail extends Component {
  static propTypes = {
    ...
    getMonthToBase: PropTypes.func.isRequired, // 根据月份获取挂牌基准价详情 WY
    monthToBase: PropTypes.object.isRequired, // 根据月份获取挂牌基准价详情 WY
  ...
  hanldeProjectAvgPriceBlur = value => {
    // 上个月基准房价
    const { monthToBase } = this.props
    const preProjectAvgPrice = monthToBase.preProjectAvgPrice
    // 当前输入的基准房价
  ...
  renderForm() {
    ...
    const { priceSourceList } = this.props.model
    ...
    return (
      <Form onSubmit={this.handleSubmit}>
        <Row>
          <Col span={10}>
            <FormItem {...formItemLayout} label="估价月份123">
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="挂牌基准价(元/㎡)">
              {getFieldDecorator('projectAvgPrice', {
                initialValue: monthToBase.projectAvgPrice
              })(
                <InputNumber
                  min={0}
                  max={1000000000}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="涨跌幅(%)">
              {getFieldDecorator('projectGained', {
                initialValue: monthToBase.projectGained
              })(
                <InputNumber
                  precision={2}
                  min={-99}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="挂牌基准价价格来源">
              {getFieldDecorator('projectPriceTypeCode', {
                initialValue: monthToBase.projectPriceTypeCode
                  ? `${monthToBase.projectPriceTypeCode}`
                  : undefined
              })(
                <Select
                  style={{ width: '100%' }}
        ...
        {/*        initialValue: monthToBase.projectBaseAvgPrice*/}
        {/*      })(*/}
        {/*        <InputNumber*/}
        {/*          min={0}*/}
        {/*          max={1000000000}*/}
        ...
        {/*        initialValue: monthToBase.projectBaseAvgPriceTypeCode*/}
        {/*          ? `${monthToBase.projectBaseAvgPriceTypeCode}`*/}
        {/*          : undefined*/}
        {/*      })(*/}
        {/*        <Select*/}
        {/*          style={{ width: '100%' }}*/}
        ...
        {/*        initialValue: monthToBase.projectBaseAvgPriceTime*/}
        {/*          ? moment(monthToBase.projectBaseAvgPriceTime)*/}
        {/*          : undefined*/}
        ...
        {/*        initialValue: monthToBase.projectBaseAvgPriceSaveUser*/}
        {/*      })(<Input disabled />)}*/}
        {/*    </FormItem>*/}
        {/*  </Col>*/}
        {/*</Row>*/}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="低层挂牌基准价(元/㎡)">
              {getFieldDecorator('lowLayerPrice', {
                initialValue: monthToBase.lowLayerPrice
              })(
                <InputNumber
                  min={0}
                  max={1000000000}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="低层挂牌基准价价格来源">
              {getFieldDecorator('lowLayerPriceTypeCode', {
                initialValue: monthToBase.lowLayerPriceTypeCode
                  ? `${monthToBase.lowLayerPriceTypeCode}`
                  : undefined
              })(
                <Select
                  style={{ width: '100%' }}
        ...
        {/*        initialValue: monthToBase.lowLayerBasePrice*/}
        {/*      })(*/}
        {/*        <InputNumber*/}
        {/*          min={0}*/}
        {/*          max={1000000000}*/}
        ...
        {/*        initialValue: monthToBase.lowLayerBasePriceTypeCode*/}
        {/*          ? `${monthToBase.lowLayerBasePriceTypeCode}`*/}
        {/*          : undefined*/}
        {/*      })(*/}
        {/*        <Select*/}
        {/*          style={{ width: '100%' }}*/}
        ...
        {/*        initialValue: monthToBase.lowLayerBasePriceTime*/}
        {/*          ? moment(monthToBase.lowLayerBasePriceTime)*/}
        {/*          : undefined*/}
        {/*      })(<DatePicker style={{ width: '100%' }} disabled />)}*/}
        {/*    </FormItem>*/}
        {/*  </Col>*/}
        ...
        {/*        initialValue: monthToBase.lowLayerBasePriceSaveUser*/}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="多层挂牌基准价(元/㎡)">
              {getFieldDecorator('multiLayerPrice', {
                initialValue: monthToBase.multiLayerPrice
              })(
                <InputNumber
                  min={0}
                  max={1000000000}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="多层挂牌基准价价格来源">
              {getFieldDecorator('multiLayerPriceTypeCode', {
                initialValue: monthToBase.multiLayerPriceTypeCode
                  ? `${monthToBase.multiLayerPriceTypeCode}`
                  : undefined
              })(
                <Select
                  style={{ width: '100%' }}
        ...
        {/*        initialValue: monthToBase.multiLayerBasePrice*/}
        {/*          ? monthToBase.multiLayerBasePrice*/}
        {/*          : undefined*/}
        {/*      })(*/}
        {/*        <InputNumber*/}
        {/*          min={0}*/}
        ...
        {/*        initialValue: monthToBase.multiLayerBasePriceTypeCode*/}
        {/*          ? `${monthToBase.multiLayerBasePriceTypeCode}`*/}
        {/*          : undefined*/}
        {/*      })(*/}
        {/*        <Select*/}
        {/*          style={{ width: '100%' }}*/}
        ...
        {/*        initialValue: monthToBase.multiLayerBasePriceTime*/}
        {/*          ? moment(monthToBase.multiLayerBasePriceTime)*/}
        {/*          : undefined*/}
        {/*      })(<DatePicker style={{ width: '100%' }} disabled />)}*/}
        {/*    </FormItem>*/}
        {/*  </Col>*/}
        ...
        {/*        initialValue: monthToBase.multiLayerBasePriceSaveUser*/}
        {/*      })(<Input disabled style={{ width: '100%' }} />)}*/}
        {/*    </FormItem>*/}
        {/*  </Col>*/}
        {/*</Row>*/}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="小高层挂牌基准价(元/㎡)">
              {getFieldDecorator('smallHighLayerPrice', {
                initialValue: monthToBase.smallHighLayerPrice
              })(
                <InputNumber
                  min={0}
                  max={1000000000}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="小高层挂牌基准价价格来源">
              {getFieldDecorator('smallHighLayerPriceTypeCode', {
                initialValue: monthToBase.smallHighLayerPriceTypeCode
                  ? `${monthToBase.smallHighLayerPriceTypeCode}`
                  : undefined
              })(
                <Select
                  style={{ width: '100%' }}
        ...
        {/*        initialValue: monthToBase.smallHighLayerBasePrice*/}
        {/*      })(*/}
        {/*        <InputNumber*/}
        {/*          min={0}*/}
        {/*          max={1000000000}*/}
        ...
        {/*        initialValue: monthToBase.smallHighLayerBasePriceTypeCode*/}
        {/*          ? `${monthToBase.smallHighLayerBasePriceTypeCode}`*/}
        {/*          : undefined*/}
        {/*      })(*/}
        {/*        <Select*/}
        {/*          style={{ width: '100%' }}*/}
        ...
        {/*        initialValue: monthToBase.smallHighLayerBasePriceTime*/}
        {/*          ? moment(monthToBase.smallHighLayerBasePriceTime)*/}
        {/*          : undefined*/}
        {/*      })(<DatePicker style={{ width: '100%' }} disabled />)}*/}
        {/*    </FormItem>*/}
        {/*  </Col>*/}
        ...
        {/*        initialValue: monthToBase.smallHighLayerBasePriceSaveUser*/}
        {/*      })(<Input disabled style={{ width: '100%' }} />)}*/}
        {/*    </FormItem>*/}
        {/*  </Col>*/}
        {/*</Row>*/}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="高层挂牌基准价(元/㎡)">
              {getFieldDecorator('highLayerPrice', {
                initialValue: monthToBase.highLayerPrice
              })(
                <InputNumber
                  min={0}
                  max={1000000000}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="高层挂牌基准价价格来源">
              {getFieldDecorator('highLayerPriceTypeCode', {
                initialValue: monthToBase.highLayerPriceTypeCode
                  ? `${monthToBase.highLayerPriceTypeCode}`
                  : undefined
              })(
                <Select
                  style={{ width: '100%' }}
        ...
        {/*        initialValue: monthToBase.highLayerBasePrice*/}
        {/*      })(*/}
        {/*        <InputNumber*/}
        {/*          min={0}*/}
        {/*          max={1000000000}*/}
        ...
        {/*        initialValue: monthToBase.highLayerBasePriceTypeCode*/}
        {/*          ? `${monthToBase.highLayerBasePriceTypeCode}`*/}
        {/*          : undefined*/}
        {/*      })(*/}
        {/*        <Select*/}
        {/*          style={{ width: '100%' }}*/}
        ...
        {/*        initialValue: monthToBase.highLayerBasePriceTime*/}
        {/*          ? moment(monthToBase.highLayerBasePriceTime)*/}
        {/*          : undefined*/}
        {/*      })(<DatePicker style={{ width: '100%' }} disabled />)}*/}
        {/*    </FormItem>*/}
        {/*  </Col>*/}
        ...
        {/*        initialValue: monthToBase.highLayerBasePriceSaveUser*/}
        {/*      })(<Input disabled style={{ width: '100%' }} />)}*/}
        {/*    </FormItem>*/}
        {/*  </Col>*/}
        {/*</Row>*/}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="超高层挂牌基准价(元/㎡)">
              {getFieldDecorator('superHighLayerPrice', {
                initialValue: monthToBase.superHighLayerPrice
              })(
                <InputNumber
                  min={0}
                  max={1000000000}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="超高层挂牌基准价价格来源">
              {getFieldDecorator('superHighLayerPriceTypeCode', {
                initialValue: monthToBase.superHighLayerPriceTypeCode
                  ? `${monthToBase.superHighLayerPriceTypeCode}`
                  : undefined
              })(
                <Select
                  style={{ width: '100%' }}
        ...
        {/*        initialValue: monthToBase.superHighLayerBasePrice*/}
        {/*      })(*/}
        {/*        <InputNumber*/}
        {/*          min={0}*/}
        {/*          max={1000000000}*/}
        ...
        {/*        initialValue: monthToBase.superHighLayerBasePriceTypeCode*/}
        {/*          ? `${monthToBase.superHighLayerBasePriceTypeCode}`*/}
        {/*          : undefined*/}
        {/*      })(*/}
        {/*        <Select*/}
        {/*          style={{ width: '100%' }}*/}
        ...
        {/*        initialValue: monthToBase.superHighLayerBasePriceTime*/}
        {/*          ? moment(monthToBase.superHighLayerBasePriceTime)*/}
        {/*          : undefined*/}
        {/*      })(<DatePicker style={{ width: '100%' }} disabled />)}*/}
        {/*    </FormItem>*/}
        {/*  </Col>*/}
        ...
        {/*        initialValue: monthToBase.superHighLayerBasePriceSaveUser*/}
        {/*      })(<Input disabled style={{ width: '100%' }} />)}*/}
        {/*    </FormItem>*/}
        {/*  </Col>*/}
        {/*</Row>*/}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="别墅(元/㎡)">
              {getFieldDecorator('villaPrice', {
                initialValue: monthToBase.villaPrice
              })(
                <InputNumber
                  min={0}
                  max={1000000000}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="联排别墅(元/㎡)">
              {getFieldDecorator('platoonVillaPrice', {
                initialValue: monthToBase.platoonVillaPrice
              })(
                <InputNumber
                  min={0}
                  max={1000000000}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="独幢别墅(元/㎡)">
              {getFieldDecorator('singleVillaPrice', {
                initialValue: monthToBase.singleVillaPrice
              })(
                <InputNumber
                  min={0}
                  max={1000000000}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="叠加别墅(元/㎡)">
              {getFieldDecorator('superpositionVillaPrice', {
                initialValue: monthToBase.superpositionVillaPrice
              })(
                <InputNumber
                  min={0}
                  max={1000000000}
          ...
          <Col span={10}>
            <FormItem {...formItemLayout} label="双拼别墅(元/㎡)">
              {getFieldDecorator('duplexesVillaPrice', {
                initialValue: monthToBase.duplexesVillaPrice
              })(
                <InputNumber
                  min={0}
                  max={1000000000}
