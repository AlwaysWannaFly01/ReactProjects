...
injectReducer({
  ...
  actionHandlers: {
    ...
    [actions.SET_PAYTYPE_CODE]: (state, { payload: [data] }) =>
      state.set('payTypeCodeList', fromJS(data)),
    [actions.SET_RENTTYPE_CODE]: (state, { payload: [data] }) =>
      state.set('rentTypeCodeList', fromJS(data))
  }
})
