 ...
 * 样本案例编辑/新增
 */
class CaseInfoSampleEdit extends Component {
  static propTypes = {
          ...
          this.props.editCase(values, res => {
            ...
            if (+code === 200) {
              ...
              const caseInfoSearch = sessionStorage.getItem(
                'CASE_INFO_SAMPLE_SEARCH'
              )
              this.props.history.push({
                pathname: router.RES_SAMPLE_CASEINFO,
  ...
  renderForm() {
    ...
    const isWithKitchenList = this.state.isWithKitchenList
        ...
        <Row>
          <Col span={10}>
            <FormItem {...formItemLayout} label=" " colon={false}>
              {caseId ? (
                <Fragment>
                  {pagePermission('fdc:hd:residence:sampleCase:change') ? (
                    <Button
                      type="primary"
                      loading={loading}
                      htmlType="submit"
                ...
                <Fragment>
                  {pagePermission('fdc:hd:residence:sampleCase:add') ? (
                    <Button
                      type="primary"
                      loading={loading}
                      htmlType="submit"
