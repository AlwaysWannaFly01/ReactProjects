 ...
 * version: 1.0
 */
class BuildingZoneSelected extends Component {
  static propTypes = {
    form: PropTypes.object,
    options: PropTypes.array,
    exportAreaData: PropTypes.func,
  ...
  handleExport() {
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        const that = this
        this.props.exportAreaData(params, () => {
          confirm({
            title: '导出提示',
            content: (
              <div>
  ...
  render() {
    ...
    return (
      <div className="fdc-house-data-base-export-building-zone-wrap">
        <div className={Styles['fileter-wrap']} style={{ margin: '5px 0' }}>
          <Form layout="inline" onSubmit={this.handleSubmit}>
            <FormItem label="行政区">
              {getFieldDecorator('areaId')(
                <Select allowClear style={{ width: 120 }} placeholder="行政区">
        ...
        <div style={{ borderBottom: '1px solid #E9E9E9', padding: '10px 0' }}>
          ...
          {pagePermission('fdc:hd:residence:base:dataSale:export') ? (
            <Button
              type="primary"
              style={{ marginRight: 8 }}
