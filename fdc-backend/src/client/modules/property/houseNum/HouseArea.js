...
import { Form, Table, Row, Col, InputNumber, Button, Message } from 'antd'
...
// 建筑面积
class HouseArea extends Component {
  static propTypes = {
  ...
  handleSetHouseArea = () => {
    ...
    if (isChosedHouseFloor) {
      ...
      const { houseArea } = this.props.form.getFieldsValue()
      if (houseArea) {
        const data = {
          cityId: this.cityId,
          buildingId: this.props.buildId,
          fieldName: 'houseArea',
          fieldValue: houseArea,
          floorList: floorNo,
          unitNoList: houseCol
        }
                      ...
                      <Col span={12}>
                        <FormItem>
                          <Button
                            ...
                            type="primary"
                            onClick={this.handleSetHouseArea}
                          >
                            设置
                          </Button>
                        </FormItem>
