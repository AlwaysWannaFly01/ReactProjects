...
class ResRatingHistoryAdd extends Component {
  static propTypes = {
    ...
    addRatingResult: PropTypes.func.isRequired,
  ...
  handleCancelAdd = () => {
    ...
    this.setState({ totalScroll: '', grade: '' })
  }
  ...
  render() {
    ...
    const { totalScroll, grade } = this.state
    return (
      <div>
        <Modal
          title="新增评级结果"
